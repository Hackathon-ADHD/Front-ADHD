...
const Signup = () => {
    ...
    const handleSubmit = () => {
        if (step === 1) {
            ...
            axiosInstance
                .post("api/login/complete-registration", postData)
                .then((response) => {
                ...
                <SignUpTextWrapper>
                    {step === 1 ? (
                        <>
                            ...
                            {errorMessage && <ErrorMessage>{errorMessage}</ErrorMessage>} {/* 추가 */}
                        ...
                        <>
                            ...
                            <InputContainer>
                                <InputField type="date" value={birthdate} onChange={handleInputChange} />
                            </InputContainer>
                            {errorMessage && <ErrorMessage>{errorMessage}</ErrorMessage>} {/* 추가 */}
